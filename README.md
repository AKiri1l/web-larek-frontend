...
### Класс Component. Класс представления.
...
### Класс ProductModel. Класс представления
...
### Класс Card. Класс Представления.
...
### Класс CardCatalog. Класс Представления.
...
### Класс CardPreview. Класс Представления.
...
### Класс CardBasket. Класс Представления.
Класс для работы с карточками в корзине, расширяет класс Card
private itemIndex: HTMLElement; - индекс товара в корзине
set index(value: number) - устанавливаем индекс товара в корзине

### Класс Order. Класс Представления.
Класс для работы с полученными данными от пользователя (оплата и адрес)
...
- protected addressInput: HTMLInputElement; - поле для введения адреса почты
...
### Класс OrderContacts. Класс Представления.
Класс для работы с полученными данными от пользователя (телефон и почта)
protected phoneInput: HTMLInputElement; - поле для введения номера
protected emailInput: HTMLInputElement; - поле для введения почты
...
### Класс Modal. Класс Представления.
...
### Класс Page. Класс Представления.
...
### Класс Form. Класс Представления.
...
### Класс Success. Класс Представления.
